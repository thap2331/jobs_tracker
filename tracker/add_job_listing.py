...
parser.add_argument('--title_in_link', '-t', default=False, help='Is the title in link')
parser.add_argument('--title_in_page_title', '-pt', default=False, help='Title in page title')
...
# AddJobListing().add_job_listing(JobMetaObject)