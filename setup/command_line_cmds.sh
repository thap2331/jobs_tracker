...
PGPASSWORD=pass psql -U postgres -h localhost -p 5433 -d test_jt_db -c 'select * from crawlogs'
PGPASSWORD=pass psql -U postgres -h localhost -p 5433 -d test_jt_db -c 'select * from cronlogs'
PGPASSWORD=pass psql -U postgres -h localhost -p 5433 -d test_jt_db -c 'delete from crawlogs'